...
<body class="antialiased">
    <div
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 text-md text-gray-700 dark:text-gray-500 ">Register</a>
                    @endif
                @endauth
            </div>
        @endif
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <center>
                <img src="https://img.freepik.com/free-vector/storehouse-workers-keeping-records-boxes_74855-11065.jpg?w=1380&t=st=1674103636~exp=1674104236~hmac=0caaa616a4c908149324eeecdf561035c690a9a7a0ea15aa628a9ff46fcce821"
                    alt="" width="400">
            </center>
            <div class="flex justify-center pt-8 sm:pt-0">
                ...
                <h1 class="h-16 w-auto text-gray-500 sm:h-20">Welcome to Inventory Management System</h1>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Manage
                                Inventory</div>
                        </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                details of the products what kind of raw material, what are the sizes we require and
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Less Storage
                            </div>
                        </div>
                    ...
                    <div class="p-6 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Improve
                                Productivity </div>
                        </div>
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                Employees are aware of stocks and the quantity that require to produce.
                            </div>
                        </div>
                    </div>
